...
<div class="mws-panel grid_8">
     <div class="mws-panel-header">
        ...
        <div class="mws-panel-body no-padding">
          <form id='form' class="mws-form" method="post" action="/update/{{$u}}" enctype='multipart/form-data'>
          {{csrf_field()}}
               <div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                         ...
                         <div class="mws-form-item">
                              <input class="small"  type="text" name="age" value="{{$res->age}}">
                         </div>
                    </div>
                   <div class="mws-form-row">
                       <label class="mws-form-label">班级</label>
                       <div class="mws-form-item">
                           <input class="small"  type="text" name="class" value="{{$res->class}}">
                       </div>
                   </div>
               </div>
